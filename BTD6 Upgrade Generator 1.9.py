...
y2 = ['Spiked Ball','Dart','Grape Shot','Glaive','Boomerang','Bomb','Tack','Blade','Bullet','Hot Grape Shot']
y3 = [f'Shoots further and can detect/pop {random.choice(y1)}',f'Hurls a giant {random.choice(y2)} that detects/pops {random.choice(y1)}',f'{random.choice(y2)}s bounce from Bloon to Bloon aggressively']

#Prints upgrade name and description.
